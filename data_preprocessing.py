...
classes = [] #list of unique labels in the data
...
def create_bot_corpus(words, classes, pattern_word_tags_list, ignore_words):
    ...
    for intent in intents['intents']:
        ...
        # Add all patterns and tags in a list
        ...
        # Add all tags in the classes list
...
# Training data set
# Input text----> like a bag of words
# Tags-----------> as a tag
...
def preprocess_train_data():
    ...
    # Convert the keywords or root and list classes to a Python pickle file format.
